...
- **Not a guarantee.** Benefit-cost ratios are modeled projections under
  ...
  methodology) — not certainties. Most published studies remain
  hazard-specific (often flood risk) and retrospective, with a real
  implementation gap between academic assessment and deployed policy.
- **No UTAC/CREP/AFET bridge.** This is a real, standalone climate
  economics/policy topic; adding this ecosystem's speculative vocabulary
  would not add anything the cited sources don't already provide.

## References

- Reguero, B.G. et al. (2018). *PLOS ONE*, 13(4), e0192132. DOI:
  10.1371/journal.pone.0192132.
- Global Commission on Adaptation (2019). *Adapt Now: A Global Call for
  Leadership on Climate Resilience*. Global Center on Adaptation / World
  Resources Institute.

All verified directly (2026-08-02) as part of the ChatGPTAnregungen.txt
sequential build-out (topic 9 of 10).
